                      ...
                      lineBarsData: [
                        LineChartBarData(
                          ...
                          belowBarData: BarAreaData(
                            show: true,
                            color: const Color(0xFF266B70).withOpacity(0.2), // Verde água com opacidade
                          ),
                    ...
                    InkWell(
                      ...
                      child: Card(
                        ...
                        child: Padding(
                          ...
                          child: Row(
                            children: [
                              Icon(Icons.list, color: const Color(0xFF266B70)), // Ícone verde-água
                              SizedBox(width: 16),
                              Text(
                    ...
                    children: [
                      PieChart(
                        PieChartData(
                          sections: [
                            PieChartSectionData(
                              color: const Color(0xFF266B70), // Parte concluída em verde água
